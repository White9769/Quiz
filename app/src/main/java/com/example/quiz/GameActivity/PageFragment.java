        ...
        for (Button i : allBtn) {
            i.setOnClickListener(new View.OnClickListener() {
                ...
                private void check(Button button) {
                    ...
                    if (button.getText().toString() == (quizInformationForPage.getCorrectAnswer())) { // правильный ответ
                        button.setBackgroundColor(green);
                        /** ****** счётчик ответов правильных ответов увеличился ****** **/
                        ...
                        if (btnAnswer0.getText().toString().equals(quizInformationForPage.getCorrectAnswer())) btnAnswer0.setBackgroundColor(green);
                        if (btnAnswer1.getText().toString().equals(quizInformationForPage.getCorrectAnswer())) btnAnswer1.setBackgroundColor(green);
                        if (btnAnswer2.getText().toString().equals(quizInformationForPage.getCorrectAnswer())) btnAnswer2.setBackgroundColor(green);
                        if (btnAnswer3.getText().toString().equals(quizInformationForPage.getCorrectAnswer())) btnAnswer3.setBackgroundColor(green);


                        /** ****** счётчик правильных ответов не увеличился ****** **/
                        pointCounter.setCounter(pointCounter.getCounter());
                    }
                    /** ****** счётчик ответов на вопросы ****** **/
